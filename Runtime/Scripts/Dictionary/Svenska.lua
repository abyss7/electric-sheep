...
--	Notify to restart.
restartLanguage = "Please reopen screensaver configuration to switch to ''${Language}''",
...
fullscreen		= "Fullscreen rendering (no need to change this except for debugging purposes)",
